...
//     orientationCity: "", // City for Orientation Information (separate from Address Information city)
...
//       const orientationCityNameValue = sourceData.cityName || sourceData.city_name;
//       if (orientationCityNameValue) {
//         formik.setFieldValue("orientationCity", orientationCityNameValue);
//         console.log("✅ Auto-populated orientationCity:", orientationCityNameValue);
//       }
//       const orientationCityIdValue = sourceData.cityId || sourceData.city_id;
//       if (orientationCityIdValue) {
//         formik.setFieldValue("orientationCityId", orientationCityIdValue);
//         console.log("✅ Auto-populated orientationCityId:", orientationCityIdValue);
//       }
...
//       // Orientation City - Auto-populate for Orientation Information
//       if (data.cityName && !formikRef.current.values.orientationCity) {
//         formikRef.current.setFieldValue("orientationCity", data.cityName);
//         console.log("✅ Setting orientationCity in Formik:", data.cityName);
//       }
//       if (data.cityId !== null && data.cityId !== undefined && !formikRef.current.values.orientationCityId) {
//         console.log("✅ Setting orientationCityId in Formik (for backend):", data.cityId);
//         formikRef.current.setFieldValue("orientationCityId", data.cityId);
//       }
...
// import { Formik, Form } from "formik";
// import { useLocation, useNavigate } from "react-router-dom";
// import clgActualSaleValidationSchema from "../../../components/applicationcomponents/sale-and-confirm/CollegSaleFormComponents/CollegeActualSaleValidationSchema";

// import styles from "./CollegeSaleForm.module.css";

// import ApplicationSaleDetails from "../../../components/applicationcomponents/sale-and-confirm/CollegSaleFormComponents/ApplicationDetails/ApplicationSaleDetails";
// import PersonalInformation from "../../../components/applicationcomponents/sale-and-confirm/CollegSaleFormComponents/PersonalInformation/PersonalInformation";
// import ParentInformation from "../../../components/applicationcomponents/sale-and-confirm/CollegSaleFormComponents/ParentInformation/ParentInformation";
// import OrientationInformation from "../../../components/applicationcomponents/sale-and-confirm/CollegSaleFormComponents/OrientationInformation/OrientaionInformation";
// import AddressInformation from "../../../components/applicationcomponents/sale-and-confirm/CollegSaleFormComponents/AddressInformation/AddressInformation";
// import ConcessionInformation from "../../../components/applicationcomponents/sale-and-confirm/CollegSaleFormComponents/ConcessionInformation/ConcessionInformation";
// import ExtraConcession from "../../../components/applicationcomponents/sale-and-confirm/CollegSaleFormComponents/ExtraConcession/ExtraConcession";
// import AcademicInformation from "../../../components/applicationcomponents/sale-and-confirm/CollegSaleFormComponents/AcademicInformation/AcademicInformation";
// import PaymentPopup from "../../../widgets/PaymentPopup/whole-payment-popup/PaymentPopup.jsx";
// import SuccessPage from "../../../widgets/sale-done/SuccessPage.jsx";

// import leftArrowBlueColor from "../../../assets/applicationassets/application-status/leftArrowBlueColor";
// import applicationSaleicon from "../../../assets/applicationassets/application-status/applicationSaleicon";
// import Button from "../../../widgets/Button/Button";
// import Popup from "../../../widgets/Popup/Popup";
// import { updateCollegeApplicationSale, mapCollegeApplicationSaleUpdateToPayload } from "../../../queries/applicationqueries/college-apis/CollegeSubmissionApi";
// import { useCollegeOverviewData } from "../../../queries/applicationqueries/college-apis/CollegeOverviewApis";
...
//   // Debug: Log fast sale data when it's loaded
//   useEffect(() => {
//     if (isFastSold && fastSaleData && !fastSaleLoading) {
//       console.log("🔍 ===== FAST SALE DATA LOADED =====");
//       console.log("Application Status:", applicationData?.status);
//       console.log("isFastSold:", isFastSold);
//       console.log("fastSaleData:", fastSaleData);
//       console.log("fastSaleData keys:", Object.keys(fastSaleData || {}));
//       console.log("Full fastSaleData structure:", JSON.stringify(fastSaleData, null, 2));
//       console.log("=====================================");
//     }
//   }, [isFastSold, fastSaleData, fastSaleLoading, applicationData?.status]);
...
//   // Handle back button click - navigate to overview if in edit mode, otherwise go back
//   const handleBackClick = () => {
//     // Check if we came from confirmation flow (returnToConfirmation flag or isEditMode)
//     const returnToConfirmation = location.state?.returnToConfirmation ||
//       location.state?.fromConfirmation ||
//       isEditMode;

//     if (returnToConfirmation && applicationData?.applicationNo) {
//       console.log("🔙 Edit Mode: Navigating back to college confirmation overview");
//       // Navigate to college confirmation overview with applicationData via proper route
//       navigate(`/scopes/application/status/${applicationData.applicationNo}/college-confirmation`, {
//         state: {
...
//         if (sourceData.quotaId || sourceData.quota_id) {
//           formik.setFieldValue("quotaId", sourceData.quotaId || sourceData.quota_id);
//           console.log("✅ Auto-populated quotaId:", sourceData.quotaId || sourceData.quota_id);
//         }
...
//         // Parent Information - Father
//         // Handle both direct fields and nested parentInfo object
//         const parentInfo = sourceData.parentInfo || {};
//         const fatherNameValue = sourceData.fatherName || sourceData.father_name || parentInfo.fatherName;
//         if (fatherNameValue) {
//           formik.setFieldValue("fatherName", fatherNameValue);
//           console.log("✅ Auto-populated fatherName:", fatherNameValue);
//         }

//         const fatherMobileValue = sourceData.fatherMobile || sourceData.fatherMobileNo || sourceData.father_mobile || sourceData.father_mobile_no || parentInfo.phoneNumber || parentInfo.fatherMobile;
//         if (fatherMobileValue) {
//           formik.setFieldValue("fatherMobile", String(fatherMobileValue));
//           console.log("✅ Auto-populated fatherMobile:", fatherMobileValue);
//         }

//         const fatherEmailValue = sourceData.fatherEmail || sourceData.father_email || parentInfo.fatherEmail || parentInfo.email;
//         // Only auto-populate if email is valid and not "not provided"
//         if (fatherEmailValue && fatherEmailValue.toLowerCase() !== "not provided") {
//           formik.setFieldValue("fatherEmail", fatherEmailValue);
//           console.log("✅ Auto-populated fatherEmail:", fatherEmailValue);
//         }

//         const fatherSectorNameValue = sourceData.fatherSectorName || sourceData.fatherSector || sourceData.father_sector_name || sourceData.father_sector;
//         // Only populate if value is not "Not provided" or empty
//         if (fatherSectorNameValue && fatherSectorNameValue.toLowerCase() !== "not provided") {
//           formik.setFieldValue("fatherSector", fatherSectorNameValue);
//           console.log("✅ Auto-populated fatherSector:", fatherSectorNameValue);
//         }
...
//         const fatherOccupationNameValue = sourceData.fatherOccupationName || sourceData.fatherOccupation || sourceData.father_occupation_name || sourceData.father_occupation;
//         // Only populate if value is not "Not provided" or empty
//         if (fatherOccupationNameValue && fatherOccupationNameValue.toLowerCase() !== "not provided") {
//           formik.setFieldValue("fatherOccupation", fatherOccupationNameValue);
//           console.log("✅ Auto-populated fatherOccupation:", fatherOccupationNameValue);
//         }
...
//         // Parent Information - Mother
//         // Handle both direct fields and nested parentInfo object
//         const motherNameValue = sourceData.motherName || sourceData.mother_name || parentInfo.motherName;
//         if (motherNameValue) {
//           formik.setFieldValue("motherName", motherNameValue);
//           console.log("✅ Auto-populated motherName:", motherNameValue);
//         }

//         const motherMobileValue = sourceData.motherMobile || sourceData.motherMobileNo || sourceData.mother_mobile || sourceData.mother_mobile_no || parentInfo.motherMobile || parentInfo.motherPhoneNumber;
//         if (motherMobileValue) {
//           formik.setFieldValue("motherMobile", String(motherMobileValue));
//           console.log("✅ Auto-populated motherMobile:", motherMobileValue);
//         }

//         const motherEmailValue = sourceData.motherEmail || sourceData.mother_email || parentInfo.motherEmail;
//         // Only auto-populate if email is valid and not "not provided"
//         if (motherEmailValue && motherEmailValue.toLowerCase() !== "not provided") {
//           formik.setFieldValue("motherEmail", motherEmailValue);
//           console.log("✅ Auto-populated motherEmail:", motherEmailValue);
//         }
...
//         const motherSectorNameValue = sourceData.motherSectorName || sourceData.motherSector || sourceData.mother_sector_name || sourceData.mother_sector;
//         // Only populate if value is not "Not provided" or empty
//         if (motherSectorNameValue && motherSectorNameValue.toLowerCase() !== "not provided") {
//           formik.setFieldValue("motherSector", motherSectorNameValue);
//           console.log("✅ Auto-populated motherSector:", motherSectorNameValue);
//         }
...
//         const motherOccupationNameValue = sourceData.motherOccupationName || sourceData.motherOccupation || sourceData.mother_occupation_name || sourceData.mother_occupation;
//         // Only populate if value is not "Not provided" or empty
//         if (motherOccupationNameValue && motherOccupationNameValue.toLowerCase() !== "not provided") {
//           formik.setFieldValue("motherOccupation", motherOccupationNameValue);
//           console.log("✅ Auto-populated motherOccupation:", motherOccupationNameValue);
//         }
...
//         const orientationCityNameValue = sourceData.cityName || sourceData.city_name;
//         if (orientationCityNameValue) {
//           // Add delay to ensure city dropdown options are loaded
//           setTimeout(() => {
//             formik.setFieldValue("orientationCity", orientationCityNameValue);
//             console.log("✅ Auto-populated orientationCity:", orientationCityNameValue);
//           }, 300);
...
//           // City - Auto-populate city from address details
//           // Set city after district is set so dropdown options are available
//           const cityNameValue = addr.cityName || addr.city || addr.city_name;
//           if (cityNameValue) {
//             // Use setTimeout to ensure city is set after district dropdown is populated and city API loads
//             // The AddressInformation component will sync cityId once city options are loaded
//             setTimeout(() => {
//               formik.setFieldValue("city", cityNameValue);
...
//           console.log("✅ Auto-populated mandalId (root level):", sourceData.mandalId || sourceData.mandal_id);
//         }
//         // City - Auto-populate city from root level data
//         // Set city after district is set so dropdown options are available
//         const cityNameRootValue = sourceData.addressCityName;
//         if (cityNameRootValue) {
//           // Use setTimeout to ensure city is set after district dropdown is populated and city API loads
//           // The AddressInformation component will sync cityId once city options are loaded
//           setTimeout(() => {
//             formik.setFieldValue("city", cityNameRootValue);
//             console.log("✅ Auto-populated city (address level):", cityNameRootValue);
//           }, 300);
//         }
//         const cityIdRootValue = sourceData.cityId || sourceData.city_id || sourceData.addressCityId;
//         if (cityIdRootValue) {
//           setTimeout(() => {
//             formik.setFieldValue("cityId", cityIdRootValue);
//             console.log("✅ Auto-populated cityId (root level):", cityIdRootValue);
//           }, 300);
//         }
...
//             console.log("Concession Values: ", {
//               firstYearConcession: formikValues.firstYearConcession,
//               firstYearConcessionTypeId: formikValues.firstYearConcessionTypeId,
//               secondYearConcession: formikValues.secondYearConcession,
//               secondYearConcessionTypeId: formikValues.secondYearConcessionTypeId,
//               concessionReason: formikValues.concessionReason,
//               concessionReasonId: formikValues.concessionReasonId,
//               referredBy: formikValues.referredBy,
//               authorizedBy: formikValues.authorizedBy,
...
//                   <div className={styles.clgAppSaleFormMiddleSection}>
//                     <PersonalInformation isEditMode={isEditMode} isFastSold={isFastSold} />
//                     <ParentInformation isEditMode={isEditMode} isFastSold={isFastSold} />
//                     <OrientationInformation
//                       initialAcademicYear={applicationDetailsData?.academicYear}
//                       initialAcademicYearId={applicationDetailsData?.academicYearId}
//                       initialCampusName={applicationDetailsData?.campusName}
...
//                               console.log("🔍 City Error Specifically:", validationErrors.city);
//                               console.log("🔍 City Value:", formik.values.city);
//                               console.log("🔍 City Touched:", formik.touched.city);
...
//                                 alert(`❌ Validation Errors Found:\n\nTotal Errors: ${Object.keys(validationErrors).length}\n\nErrors:\n${errorMessages}`);
//                               }

//                               if (Object.keys(validationErrors).length === 0) {
//                                 // Store all form values (make a deep copy to ensure latest state)
//                                 // IMPORTANT: Get the latest formik.values directly to ensure siblings are included
//                                 const currentFormikValues = formik.values;

//                                 // CRITICAL: Get siblings directly from formik.values to ensure we have the latest
//                                 const siblingsFromFormik = Array.isArray(currentFormikValues.siblings)
//                                   ? currentFormikValues.siblings
//                                   : [];

//                                 console.log('🔍 ===== CAPTURING FORM VALUES (Before Deep Copy) =====');
//                                 console.log('  - formik.values.siblings (direct access):', siblingsFromFormik);
//                                 console.log('  - siblings length:', siblingsFromFormik.length);
...
//                                 const values = JSON.parse(JSON.stringify(currentFormikValues));

//                                 // CRITICAL: Explicitly set siblings from formik.values to ensure they're included
//                                 // This is a safeguard in case JSON.parse/stringify loses the array
//                                 if (siblingsFromFormik.length > 0) {
//                                   values.siblings = JSON.parse(JSON.stringify(siblingsFromFormik));
//                                   console.log('✅ Explicitly set siblings in values:', values.siblings);
//                                 } else if (!values.siblings || !Array.isArray(values.siblings) || values.siblings.length === 0) {
//                                   console.warn('⚠️ Siblings array is empty or missing in formik.values');
//                                   values.siblings = [];
//                                 }
...
//                                   secondYearConcessionTypeId: values.secondYearConcessionTypeId,
//                                   concessionReason: values.concessionReason,
//                                   authorizedBy: values.authorizedById,
//                                   referredBy: values.referredById,
//                                   description: values.description,
//                                 });
//                                 console.log("Acadamic Information:", {
//                                   interFirstYearHallTicket: values.interFirstYearHallTicketNo,
//                                   interHallTicket: values.interHallTicketNo,
//                                   tenthHallTicket: values.hallTicketNo,
//                                   anotherHallTicket: values.tenthHallTicketNo,
//                                 })
//                                 console.log('============================================================');
...
//                                 // Store all form data for college application sale (includes all concession fields)
//                                 console.log('🔍 ===== SETTING FORM VALUES (Proceed to Sale) =====');
//                                 console.log('  - formik.values.siblings (direct):', currentFormikValues.siblings);
//                                 console.log('  - values.siblings (after deep copy):', values.siblings);
//                                 console.log('  - values.siblings type:', typeof values.siblings);
//                                 console.log('  - values.siblings is array?', Array.isArray(values.siblings));
//                                 console.log('  - values.siblings length:', values.siblings?.length || 0);
//                                 if (values.siblings && values.siblings.length > 0) {
//                                   console.log('  - First sibling:', values.siblings[0]);
//                                   console.log('  - All siblings:', JSON.stringify(values.siblings, null, 2));
//                                 } else {
//                                   console.warn('⚠️ WARNING: Siblings array is empty!');
//                                   console.log('  - Checking formik.values directly:', currentFormikValues.siblings);
//                                 }
...
//                                 // Open payment popup only if validation passes
//                                 setShowPaymentPopup(true);
//                               } else {
//                                 // IMPORTANT: Set errors in Formik's state so components can access them
//                                 // Use setErrors to set all errors at once
//                                 formik.setErrors(validationErrors);

//                                 // Also set field errors individually to ensure they're immediately available
//                                 // This is especially important for fields like city that might not update immediately
//                                 Object.keys(validationErrors).forEach((fieldName) => {
//                                   formik.setFieldError(fieldName, validationErrors[fieldName]);
//                                 });

//                                 // Mark all fields as touched to show errors
//                                 const allFieldsTouched = Object.keys(formik.values).reduce(
//                                   (acc, key) => ({ ...acc, [key]: true }),
//                                   {}
//                                 );
//                                 formik.setTouched(allFieldsTouched);

//                                 // Log city-specific debugging info
//                                 console.log("🔍 City Field Debug Info:");
//                                 console.log("  - City value:", formik.values.city);
//                                 console.log("  - City error from validation:", validationErrors.city);
//                                 console.log("  - City will be touched:", allFieldsTouched.city);
//                                 console.log("  - City error should display:", validationErrors.city && allFieldsTouched.city);
//                                 console.log("  - Formik errors after setErrors:", formik.errors);

//                                 // Force a small delay to ensure state updates, then verify
//                                 setTimeout(() => {
//                                   console.log("🔍 City Field After State Update:");
//                                   console.log("  - City error in formik.errors:", formik.errors.city);
//                                   console.log("  - City touched:", formik.touched.city);
//                                 }, 100);
...
//                             console.log('✅ Update successful:', response);
//                             console.log('🔄 Navigating back to college confirmation overview');
...
//                             if (returnToConfirmation && applicationData?.applicationNo) {
//                               // Navigate back to college confirmation overview with proper route
//                               console.log('📍 Navigating to confirmation overview:', applicationData.applicationNo);
//                               navigate(`/scopes/application/status/${applicationData.applicationNo}/college-confirmation`, {
//                                 state: {
//                                   applicationData: {
//                                     ...applicationData,
...
//                               });
//                             } else {
//                               // Fallback: Navigate to application status table
//                               alert("Application updated successfully!");
//                               navigate('/scopes/application/status');
//                             }
//                           } catch (error) {
...
//           {/* Payment Popup */}
//           {showPaymentPopup && (() => {
//             // Merge fast sale payment amount into applicationDetailsData if available
//             let mergedApplicationDetailsData = applicationDetailsData;

//             if (isFastSold && fastSaleData && applicationDetailsData) {
//               console.log("🔍 ===== FAST SALE PAYMENT AMOUNT DETECTION =====");
//               console.log("isFastSold:", isFastSold);
//               console.log("fastSaleData:", fastSaleData);
//               console.log("fastSaleData keys:", fastSaleData ? Object.keys(fastSaleData) : "null");

//               // Log the entire fastSaleData structure to understand its format
//               console.log("📦 Full fastSaleData structure:", JSON.stringify(fastSaleData, null, 2));

//               // Check multiple possible paths for payment amount in fastSaleData
//               // The payment amount could be in various nested structures
//               const paymentAmount =
//                 // Direct paths
//                 fastSaleData?.paymentDetails?.amount ||
//                 fastSaleData?.payment?.amount ||
//                 fastSaleData?.paymentAmount ||
//                 fastSaleData?.amount ||
//                 // Nested in data object
//                 fastSaleData?.data?.paymentDetails?.amount ||
//                 fastSaleData?.data?.payment?.amount ||
//                 fastSaleData?.data?.amount ||
//                 // Check if paymentDetails is an array
//                 (Array.isArray(fastSaleData?.paymentDetails) && fastSaleData.paymentDetails[0]?.amount) ||
//                 (Array.isArray(fastSaleData?.data?.paymentDetails) && fastSaleData.data.paymentDetails[0]?.amount) ||
//                 // Check paymentInfo or payment_info
//                 fastSaleData?.paymentInfo?.amount ||
//                 fastSaleData?.payment_info?.amount ||
//                 fastSaleData?.data?.paymentInfo?.amount ||
//                 fastSaleData?.data?.payment_info?.amount ||
//                 null;

//               console.log("💰 Payment Amount Search Result:", paymentAmount);

//               if (paymentAmount) {
//                 console.log("✅ Fast Sale - Found previously submitted payment amount:", paymentAmount);
//                 console.log("💰 Fast Sale Data Structure Check:", {
//                   hasPaymentDetails: !!fastSaleData?.paymentDetails,
//                   hasPayment: !!fastSaleData?.payment,
//                   hasPaymentAmount: !!fastSaleData?.paymentAmount,
//                   hasAmount: !!fastSaleData?.amount,
//                   hasDataPaymentDetails: !!fastSaleData?.data?.paymentDetails,
//                   hasPaymentInfo: !!fastSaleData?.paymentInfo,
//                   paymentAmount: paymentAmount
//                 });
//                 console.log("💰 Merging payment amount into applicationDetailsData for auto-population");
//                 mergedApplicationDetailsData = {
//                   ...applicationDetailsData,
//                   amount: paymentAmount.toString(), // Override amount with previously submitted payment
//                   previouslySubmittedAmount: paymentAmount.toString() // Also store as separate field for reference
//                 };
//               } else {
//                 console.log("⚠️ Fast Sale - No payment amount found in fastSaleData");
//                 console.log("   Fast Sale Data Keys:", fastSaleData ? Object.keys(fastSaleData) : "fastSaleData is null");
//                 console.log("   Checking if payment was already included in applicationDetailsData.amount:", applicationDetailsData?.amount);

//                 // If payment amount is not found but we have an amount in applicationDetailsData,
//                 // it might already be the total payment amount from fast sale
//                 // In this case, we should use it as the previously submitted amount
//                 if (applicationDetailsData?.amount && parseFloat(applicationDetailsData.amount) > 0) {
//                   const existingAmount = parseFloat(applicationDetailsData.amount);
//                   const appFee = parseFloat(applicationDetailsData.appFee || applicationDetailsData.applicationFee) || 0;

//                   // If the amount is significantly larger than appFee, it might be the total payment
//                   // Otherwise, it's just the amount field (not the total payment)
//                   if (existingAmount > appFee) {
//                     console.log("💰 Using existing amount as previously submitted payment:", existingAmount);
//                     mergedApplicationDetailsData = {
//                       ...applicationDetailsData,
//                       previouslySubmittedAmount: existingAmount.toString()
//                     };
//                   }
//                 }
//               }
...
//               <PaymentPopup
//                 onClose={() => setShowPaymentPopup(false)}
//                 title="Complete Application Sale"
//                 formData={formValues || {}}
//                 siblings={formValues?.siblings || []}
//                 detailsObject={applicationData}
//                 applicationDetailsData={mergedApplicationDetailsData}
//                 type="college"
//                 collegeFormData={formValues}
//                 collegeAcademicFormData={academicFormValues}
//                 saleType="regular"
