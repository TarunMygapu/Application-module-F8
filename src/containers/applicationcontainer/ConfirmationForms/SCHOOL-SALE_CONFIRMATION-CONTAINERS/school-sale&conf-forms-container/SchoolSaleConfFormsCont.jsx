...
import SchoolSaleConfParentInfo from "../../../../../components/applicationcomponents/sale-and-confirm/ConfirmationFormComponents/SCHOOL-SALE-CONFIRMATION/school-sale-and-conformation-form/school-sale&conf-parent-information/SchoolSaleConfParentInfo.jsx";
import SchoolSaleConfSiblingInfo from "../../../../../components/applicationcomponents/sale-and-confirm/ConfirmationFormComponents/SCHOOL-SALE-CONFIRMATION/school-sale-and-conformation-form/school-sale&conf-sibling-info/SchoolSaleConfSiblingInfo.jsx";
import Button from "../../../../../widgets/Button/Button";
import styles from "./SchoolSaleConfFormsCont.module.css";
import SchoolSaleConfAcadeInfo from "../../../../../components/applicationcomponents/sale-and-confirm/ConfirmationFormComponents/SCHOOL-SALE-CONFIRMATION/school-sale-and-conformation-form/school-sale&conf-academic-info/SchoolSaleConfAcadeInfo.jsx";
import SchoolSaleConfLangInfo from "../../../../../components/applicationcomponents/sale-and-confirm/ConfirmationFormComponents/SCHOOL-SALE-CONFIRMATION/school-sale-and-conformation-form/school-sale&conf-language-info/SchoolSaleConfLangInfo.jsx";
import SchoolSaleConfConceInfo from "../../../../../components/applicationcomponents/sale-and-confirm/ConfirmationFormComponents/SCHOOL-SALE-CONFIRMATION/school-sale-and-conformation-form/school-sale&conf-concestion-info/SchoolSaleConfConceInfo.jsx";
...
import useParentValidation from "../../../../../components/applicationcomponents/sale-and-confirm/ConfirmationFormComponents/SCHOOL-SALE-CONFIRMATION/school-sale-and-conformation-form/school-sale&conf-parent-information/hooks/useParentValidation";
import { validateConcessionInfo } from "../../../../../components/applicationcomponents/sale-and-confirm/ConfirmationFormComponents/SCHOOL-SALE-CONFIRMATION/school-sale-and-conformation-form/school-sale&conf-academic-info/utils/academicValidation";
import { validateLanguageInfo } from "../../../../../components/applicationcomponents/sale-and-confirm/ConfirmationFormComponents/SCHOOL-SALE-CONFIRMATION/school-sale-and-conformation-form/school-sale&conf-language-info/utils/languageValidation";
import { useOrientations } from "../../../../../components/applicationcomponents/sale-and-confirm/ConfirmationFormComponents/SCHOOL-SALE-CONFIRMATION/school-sale-and-conformation-form/school-sale&conf-academic-info/hooks/SchoolAcedemic";
...
const SchoolSaleConfFormsCont = ({ onBack, onProceedToPayment, detailsObject, overviewData }) => {
  ...
  const handleProceedToPayment = () => {
    // Run all validations together so that all error messages are shown at once
    const languageErrors = validateLanguageInfo(formData);
 
    // This validates parent, sibling, academic and concession information
    ...
    if (Object.keys(combinedErrors).length > 0) {
      // Store all validation errors for inline display
      setValidationErrors(combinedErrors);
 
      // Decide which field to scroll to first
      let firstErrorField = null;
 
      const languageErrorKeys = Object.keys(languageErrors);
      if (languageErrorKeys.length > 0) {
        firstErrorField = languageErrorKeys[0];
      } else if (validationResult.firstErrorField) {
        firstErrorField = validationResult.firstErrorField;
      }
 
      if (firstErrorField) {
        // Handle sibling field errors (format: sibling_${id}_fieldName)
        if (firstErrorField.startsWith("sibling_")) {
