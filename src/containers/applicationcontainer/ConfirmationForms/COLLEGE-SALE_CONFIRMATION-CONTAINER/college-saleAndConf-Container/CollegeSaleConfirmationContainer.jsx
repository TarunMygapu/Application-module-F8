  ...
  const handleEdit = () => {
    ...
    navigate(`/scopes/application/status/${applicationNo}/college-sale`, {
      state: {
        ...
        overviewData: overviewData,
        isEditMode: true, // Flag to indicate this is edit mode
        fromConfirmation: true, // Flag to indicate coming from confirmation flow
        returnToConfirmation: true // Flag to indicate should return to confirmation after update
      }
    });
  };
