...
import schoolSaleValidationSchema from "./schoolSaleValidations.js"
...
import rightArrowBlueColor from "../../../assets/applicationassets/application-status/rightArrowBlueColor";
import PaymentPopup from "../../../widgets/PaymentPopup/whole-payment-popup/PaymentPopup.jsx";
import SuccessPage from "../../../widgets/sale-done/SuccessPage";
import { submitSchoolApplicationSaleOnly, mapSchoolApplicationSaleOnlyToPayload, updateSchoolApplicationSale, mapSchoolApplicationSaleUpdateToPayload } from "../../../queries/applicationqueries/school-apis/SchoolSubmissionApi";
 
import PersonalInformationForSchool from "../../../components/applicationcomponents/sale-and-confirm/CollegSaleFormComponents/PersonalInformation/PersnoalInformationForSchool";
import ParentInformationForSchool from "../../../components/applicationcomponents/sale-and-confirm/CollegSaleFormComponents/ParentInformation/ParentInformationForSchool";
import OrientationInformationForSchool from "../../../components/applicationcomponents/sale-and-confirm/CollegSaleFormComponents/OrientationInformation/OrientationInformationForSchool";
    ...
    <>
      {!showSuccessPage ? (
        <>
          <Formik
            initialValues={initialValues}
            validationSchema={schoolSaleValidationSchema()}
            onSubmit={(values) => {
              console.log("📤 School Sale Submit:", values);
              // alert("School Sale Submitted!");
            }}
          ...
          {/* -- ALL MIDDLE COMPONENTS -- */}
          <div className={styles.clgAppSaleFormMiddleSection}>
            <PersonalInformationForSchool isEditMode={isEditMode} />
            <ParentInformationForSchool isEditMode={isEditMode} />
            <OrientationInformationForSchool
              initialAcademicYear={applicationDetailsData?.academicYear}
              initialAcademicYearId={applicationDetailsData?.academicYearId}
              initialCampusName={applicationDetailsData?.campusName}
