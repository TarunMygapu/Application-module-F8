...
const Statusbar = ({ isSold, isConfirmed, isDamaged, isPaymentPending, isUnavailable, showLabels = true, reducedGap = false, labelWidth = "100%", singleStar = false, reverseOrder = false }) => {
  const blue = "#3425FF";
  const red = "#FF2525";

  // If payment pending, show single blue star with tick
  if (isPaymentPending) {
    return (
        ...
        {showLabels && (
          ...
          >
            <div className={styles.label_container}>
              <span className={styles.label_payment_pending}>
                Payment Pending
              </span>
            </div>
          </div>
  ...
  // If unavailable, show single gray star with cross
  if (isUnavailable) {
    const gray = "#434141";
    return (
      <div className={styles.status_container}>
        ...
        {showLabels && (
          ...
          >
            <div className={styles.label_container}>
              <span className={styles.label_unavailable}>
                Unavailable
              </span>
            </div>
          </div>
