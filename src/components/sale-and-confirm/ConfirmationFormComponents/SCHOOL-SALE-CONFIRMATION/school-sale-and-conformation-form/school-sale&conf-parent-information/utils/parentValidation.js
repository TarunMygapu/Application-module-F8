...
export function validateParentInfo(formData) {
  ...
  const fatherSector = formData.fatherSector;
  ...
  const motherSector = formData.motherSector;
  ...
  // Validate Father Sector - Required only if father name or phone is entered
  if (fatherName || fatherPhone) {
    if (!fatherSector || fatherSector === "" || fatherSector === null || fatherSector === undefined || fatherSector === 0) {
      errors.fatherSector = "Sector is required";
    }
  }

  // Validate Father Occupation - Required only if father name or phone is entered
  if (fatherName || fatherPhone) {
    if (!fatherOccupation || fatherOccupation === "" || fatherOccupation === null || fatherOccupation === undefined || fatherOccupation === 0) {
      errors.fatherOccupation = "Occupation is required";
    }
  }

  // Validate Mother Sector - Required only if mother name or phone is entered
  if (motherName || motherPhone) {
    if (!motherSector || motherSector === "" || motherSector === null || motherSector === undefined || motherSector === 0) {
      errors.motherSector = "Sector is required";
    }
  }

  // Validate Mother Occupation - Required only if mother name or phone is entered
  if (motherName || motherPhone) {
    if (!motherOccupation || motherOccupation === "" || motherOccupation === null || motherOccupation === undefined || motherOccupation === 0) {
      errors.motherOccupation = "Occupation is required";
    }
  }
