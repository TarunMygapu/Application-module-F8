...
import blueLine from "../../../../../assets/applicationassets/application-analytics/blue_arrow_line.png"
import analyticsSearchBarAboveIcon from "../../../../../assets/applicationassets/application-analytics/analytics-search-bar-above-icon";
...
const ApplicationSearchHeader = () => {
  return (
    <div id="search_header_wrapper" className={styles.search_header_wrapper}>
      ...
      <figure>
        {/* <img src={analyticsSearchBarAboveIcon}/> */}
        {analyticsSearchBarAboveIcon}
      </figure>
    </div>
  );
};
