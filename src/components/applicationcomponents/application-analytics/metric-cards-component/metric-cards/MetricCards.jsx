...
const MetricCards = () => {
  ...
  const selectedDgmQuery = useGetAnalyticsForDgm(selectedEntity.id, {
    enabled: !!selectedEntity.id && selectedEntity.type === "dgm",
  });
  ...
  if (selectedEntity.id) {
    let selectedQuery;
    if (selectedEntity.type === "zone") selectedQuery = selectedZoneQuery;
    else if (selectedEntity.type === "dgm") selectedQuery = selectedDgmQuery;
    else selectedQuery = selectedCampusQuery;
        ...
        return (
          <div className={`${styles.metric_card} ${cardColor}`} key={index}>
            <div className={styles.metric_card_values}>
              ...
              <div className={styles.card_value_and_title}>
                <strong className={styles.card_value}>{formatFee(card.value)}</strong>
                <p className={styles.card_state}>{card.title}</p>
              </div>
            </div>
          </div>
