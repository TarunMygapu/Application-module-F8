...
import { useNavigate } from "react-router-dom";
import styles from "./SearchResultCardWithStatus.module.css";
import DivisionDesign from "../../../../assets/applicationassets/application-status/application-status/DivisionDesign.svg";
import Statusbar from "../../../../widgets/StatusBar/Statusbar";
import PopupcloseIcon from "../../../../assets/applicationassets/application-status/kindOfSaleIcons(college)/PopupcloseIcon.svg";
import ApplicationSaleIcon from "../../../../assets/applicationassets/application-status/kindOfSaleIcons(college)/ApplicationSaleIcon.svg";
import ApplicationFastSaleIcon from "../../../../assets/applicationassets/application-status/kindOfSaleIcons(college)/ApplicationFastSaleIcon.svg";
