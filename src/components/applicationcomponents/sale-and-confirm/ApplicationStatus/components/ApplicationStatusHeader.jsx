...
import searchIcon from '../../../../../assets/applicationassets/application-status/application-status/Group.svg';
import filterIcon from '../../../../../assets/applicationassets/application-status/application-status/Filter.svg';
import appliedFilterIcon from '../../../../../assets/applicationassets/application-status/application-status/Vector.svg';
import exportIcon from '../../../../../assets/applicationassets/application-status/application-status/Arrow up.svg';
