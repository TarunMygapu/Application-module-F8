...
const FilterPanel = ({
  ...
  // Debug: Log category to verify it's being passed correctly
  console.log('🔍 FilterPanel - Category received:', category);
      ...
      <div className={styles.filter_panel__student_category}>
        ...
        <div className={styles.filter_panel__student_category_grid}>
          {[
            ...
            { key: "unsold", label: "Fast Sold" }, // Hide this for school category
            { key: "withPro", label: "With PRO" },
            { key: "damaged", label: "Damaged" },
            { key: "unavailable", label: "Unavailable" },
          ]
          .filter(({ key }) => {
            // Hide "Fast Sold" option when category is "school" (case-insensitive)
            const categoryLower = (category || 'school').toLowerCase().trim();
            if (key === "unsold" && categoryLower === "school") {
              console.log('🚫 FilterPanel - Hiding "Fast Sold" option for school category');
              return false;
            }
            return true;
          })
