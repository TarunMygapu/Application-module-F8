...
import { useGetTableDetailsByEmpId, useGetApplicationSeriesForEmpId, useGetDistributionId, useGetAllFeeAmounts } from "../../../../queries/applicationqueries/application-distribution/dropdownqueries";
import Spinner from "../../../commoncomponents/Spinner";


const ZoneTable = ({ onSelectionChange, callTable, tableTrigger, setTableTrigger }) => {
  ...
  // 🔑 FIX: Notify parent of selection changes safely outside the render cycle
  useEffect(() => {
