...
import applicationnavtabsicon from "../../../assets/applicationassets/application-distribution/applicationnavtabsicon";
...
import plusicon from "../../../assets/applicationassets/application-distribution/plusicon";
import AccordiansContainer from "../../../containers/applicationcontainer/application-analytics-containers/accordians-container/AccordiansContainer";
import headerIon from "../../../assets/applicationassets/application-analytics/accordians_header.png";
import endicon from "../../../assets/applicationassets/application-analytics/blue_arrow_line.png";
import filterIcon from "../../../assets/applicationassets/application-distribution/filterIcon";
...
const DistributeTab = () => {
  ...
  const distributeSubText = () => {
    const currentLocation = location.pathname;
    if (currentLocation.includes("zone"))
      return "Distribute Applications To All Zones.";
