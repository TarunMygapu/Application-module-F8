...
const getEmployeesByZone = async (zoneId,campusCategory) =>
  (await axios.get(`${BASE_URL}${DISTRIBUTION_GETS}/zone/${zoneId}/employees?category=${campusCategory}`))
    .data;
...
const getCampusesByCity = async (cityId, category) =>
...
export const useGetEmployeesByZone = (zoneId,campusCategory) =>
  useQuery({
    queryKey: ["employees-by-zone", zoneId,campusCategory],
    queryFn: () => getEmployeesByZone(zoneId,campusCategory),
    enabled: !!zoneId,
  });
...
export const useGetCampusesByCity = (cityId, category) =>
  useQuery({
    queryKey: ["campuses-by-city", cityId],
    queryFn: () => getCampusesByCity(cityId, category),
